...
/* Small inline icons, zero extra dependencies. Swap for lucide-react
   ...
   consistent app-wide — the sizing/stroke here matches that style. */
...
export function IconUploadCloud() {
  return (
    <svg
...
export function IconStar({ filled = false }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M12 2.5l3 6.5 7 .9-5.2 4.9 1.4 6.9L12 18l-6.2 3.7 1.4-6.9L2 9.9l7-.9z" />
    </svg>
  );
}
...
export function IconFolderColored() {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconFlask() {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M9 2h6M10 2v6.5L4.7 18a2 2 0 0 0 1.7 3h11.2a2 2 0 0 0 1.7-3L14 8.5V2" />
      <path d="M7.5 15h9" />
    </svg>
  );
}
...
export function IconReceipt() {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M5 2.5h14v19l-2.5-1.5L14 21.5 11.5 20 9 21.5 6.5 20 4 21.5V2.5z" />
...
export function IconInboxCheck() {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M4 13h4.5l1.2 2.2h4.6L15.5 13H20" />
      <path d="M4 13v4.5A1.5 1.5 0 0 0 5.5 19h13a1.5 1.5 0 0 0 1.5-1.5V13" />
      <path d="M9.3 9.3l1.7 1.7 3.2-3.2" />
    </svg>
  );
}
...
export function IconTrash() {
  return (
    ...
    >
      <path d="M3 6.5h18" />
      <path d="M8 6.5V4.5a1.5 1.5 0 0 1 1.5-1.5h5A1.5 1.5 0 0 1 16 4.5v2" />
      <path d="M5.5 6.5l1 13.5A1.5 1.5 0 0 0 8 21.5h8a1.5 1.5 0 0 0 1.5-1.5l1-13.5" />
...
export function IconLightbulb() {
  return (
    ...
    >
      ...
      <path d="M12 2a6.5 6.5 0 0 0-3.7 11.8c.6.44 1 1.15 1 1.95V16h5.4v-.25c0-.8.4-1.5 1-1.95A6.5 6.5 0 0 0 12 2z" />
    </svg>
  );
}
...
export function IconThumbsUp() {
  return (
    ...
    >
      <path d="M7 22V10.5" />
      <path d="M7 10.5l4-8a2 2 0 0 1 2 2v5h6a2 2 0 0 1 2 2.3l-1.5 8A2 2 0 0 1 17.5 22H7" />
    </svg>
  );
}
...
export function IconThumbsDown() {
  return (
    ...
    >
      <path d="M17 2v11.5" />
      <path d="M17 13.5l-4 8a2 2 0 0 1-2-2v-5H5a2 2 0 0 1-2-2.3l1.5-8A2 2 0 0 1 6.5 2H17" />
    </svg>
  );
}
...
export function IconStethoscope() {
  return (
    ...
    >
      ...
      <circle cx="5" cy="3" r="0" />
    </svg>
  );
}

export function IconPersonDoctor() {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M9.5 17.5v1.2M14.5 17.5v1.2" />
    </svg>
  );
}
...
export function IconPaperclip() {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M20 11.5L12.5 19a4.5 4.5 0 0 1-6.4-6.4l8-8a3 3 0 0 1 4.2 4.2l-7.6 7.6a1.5 1.5 0 0 1-2.1-2.1l6.9-6.9" />
    </svg>
  );
}
...
export function IconDoubleCheck() {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M1.5 12.5l4 4L14 8" />
      <path d="M9.5 12.5l4 4L22 8" />
    </svg>
  );
}
...
export function IconLeaf() {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M5 20c-1-6 1.5-15 15-15 1 8-4 14-11 14H5z" />
      <path d="M5 20c1.5-3.5 4-6.5 8-9" />
    </svg>
  );
}
